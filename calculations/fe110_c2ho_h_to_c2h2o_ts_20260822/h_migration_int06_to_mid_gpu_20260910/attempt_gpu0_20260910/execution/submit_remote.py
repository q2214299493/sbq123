...
def main():
    ...
    assert auth['authorized'] is True and auth['user_instruction']=='提交gpu0'
    assert auth['action']=='user_requested_gpu0_attempt' and not auth['vasp_authorized']
