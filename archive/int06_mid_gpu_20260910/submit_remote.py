...
def main():
    ...
    assert auth['authorized'] is True and auth['user_instruction']=='提交'
    assert auth['action']=='initial_gpu_path_candidate' and not auth['vasp_authorized']
    ...
    environment={
        ...
        'MIN_FREE_GPU_MEMORY_MIB':'12000','REAL_JOB_WRAPPER':str(root/'runtime/dual_model_ml_neb_job.sh'),
    }
