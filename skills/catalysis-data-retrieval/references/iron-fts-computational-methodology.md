...
**Reviewed:** 2026-09-25
**Scope:** 27 peer-reviewed primary computational, kinetic, isotope-tracing,
and combined theory/experiment papers on iron and iron-carbide Fischer–Tropsch
synthesis (FTS): the original 20-paper mechanism set plus seven evidence-bridge
papers. This
...
level only; Wu et al. was checked against the publisher article summary. Do not
...
| Model family represented here | Examples in the 27-paper set | What must remain explicit |
|---|---|---|
| Metallic bcc Fe | Fe(100), stepped Fe(710); carbon-covered Fe(100)/(110)/(210) | Facet/step topology, surface carbon coverage, H/CO coadsorption, and whether the model is clean, precovered or carburized. |
...
| Promoted carbide models | K₂O/χ-Fe₅C₂ and promoted Fe-carbide catalyst studies | Promoter species and chemical state, exact position/distance to active site, loading, support/model boundary, and whether evidence is computational or experimental. |
...
```mermaid
flowchart LR
    C[Pre-treatment and FTS conditions<br/>T, pressure, H2/CO, carbon/oxygen potential]
